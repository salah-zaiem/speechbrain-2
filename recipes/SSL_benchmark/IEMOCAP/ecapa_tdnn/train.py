...
The system classifies 4 emotions ( anger, happiness, sadness, neutrality) with encoder.

To run this recipe, do the following:
> python train_with_encoder.py hparams/train_with_encoder.yaml --data_folder /path/to/IEMOCAP_full_release

For more encoder/HuBERT results, please see https://arxiv.org/pdf/2111.02735.pdf
...
class EmoIdBrain(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        embeddings = self.modules.embedding_model(layer_0, lens)
    ...
    def init_optimizers(self):
        ...
        if self.checkpointer is not None:
            ...
            self.checkpointer.add_recoverable(
                "wav2vec_opt", self.encoder_optimizer
            )
